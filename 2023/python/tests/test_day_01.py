...
class TestClass:
    ...
    def test_digits_are_extracted_from_string(
        self, character_seq: str, expected_length: int
    ):
        # GIVEN
        solution = Solution()
        # WHEN
